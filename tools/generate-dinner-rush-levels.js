...
const POOL = [
  { id: "pancakes", name: "Pancakes", emoji: "🥞", meal: "breakfast", color: "#e8a13c",
    steps: [{ type: "counter", duration: 10, label: "Mix Batter" }, { type: "stovetop", duration: 10, label: "Griddle" }, { type: "counter", duration: 5, label: "Stack & Butter" }] },
  { id: "eggs", name: "Scrambled Eggs", emoji: "🍳", meal: "breakfast", color: "#f0c419",
    steps: [{ type: "counter", duration: 5, label: "Whisk" }, { type: "stovetop", duration: 5, label: "Scramble" }] },
  ...
  { id: "oatmeal", name: "Oatmeal", emoji: "🥣", meal: "breakfast", color: "#a9744f",
    steps: [{ type: "counter", duration: 5, label: "Measure Oats" }, { type: "stovetop", duration: 10, label: "Simmer" }, { type: "counter", duration: 5, label: "Add Toppings" }] },
  { id: "frenchtoast", name: "French Toast", emoji: "🍞", meal: "breakfast", color: "#d4a373",
    steps: [{ type: "counter", duration: 10, label: "Dip in Batter" }, { type: "stovetop", duration: 15, label: "Griddle" }, { type: "counter", duration: 5, label: "Dust & Plate" }] },
  { id: "hashbrowns", name: "Hash Browns", emoji: "🥔", meal: "breakfast", color: "#e9b44c",
    steps: [{ type: "counter", duration: 10, label: "Shred Potatoes" }, { type: "stovetop", duration: 15, label: "Fry" }] },
  { id: "omelette", name: "Omelette", emoji: "🍳", meal: "breakfast", color: "#f4a259",
    steps: [{ type: "counter", duration: 10, label: "Whisk & Fill" }, { type: "stovetop", duration: 10, label: "Fold & Cook" }] },

  { id: "grilledcheese", name: "Grilled Cheese", emoji: "🧀", meal: "lunch", color: "#e8622c",
    steps: [{ type: "counter", duration: 5, label: "Butter Bread" }, { type: "stovetop", duration: 10, label: "Grill" }] },
  { id: "tomatosoup", name: "Tomato Soup", emoji: "🍅", meal: "lunch", color: "#3a86ff",
    steps: [{ type: "counter", duration: 10, label: "Chop Veg" }, { type: "stovetop", duration: 15, label: "Simmer & Blend" }] },
  ...
  { id: "gardensalad", name: "Garden Salad", emoji: "🥬", meal: "lunch", color: "#3a9d5d",
    steps: [{ type: "counter", duration: 10, label: "Wash & Chop" }] },
  { id: "grilledcheeseclub", name: "Club Sandwich", emoji: "🥪", meal: "lunch", color: "#bc6c25",
    steps: [{ type: "counter", duration: 10, label: "Layer Fillings" }, { type: "stovetop", duration: 5, label: "Toast" }] },
  { id: "quesadilla", name: "Quesadilla", emoji: "🫓", meal: "lunch", color: "#e9b44c",
    steps: [{ type: "counter", duration: 10, label: "Fill Tortilla" }, { type: "stovetop", duration: 10, label: "Grill" }, { type: "counter", duration: 5, label: "Slice & Plate" }] },
  { id: "grilledchicken", name: "Grilled Chicken Breast", emoji: "🍗", meal: "lunch", color: "#c1666b",
    steps: [{ type: "counter", duration: 10, label: "Marinate" }, { type: "stovetop", duration: 15, label: "Grill" }, { type: "counter", duration: 5, label: "Rest & Slice" }] },
  { id: "friedrice", name: "Fried Rice", emoji: "🍚", meal: "lunch", color: "#e9c46a",
    steps: [{ type: "counter", duration: 10, label: "Chop Veg" }, { type: "stovetop", duration: 15, label: "Stir-fry" }] },

  { id: "spaghetti", name: "Spaghetti", emoji: "🍝", meal: "dinner", color: "#e8622c",
    steps: [{ type: "counter", duration: 5, label: "Salt the Water" }, { type: "stovetop", duration: 10, label: "Boil Pasta" }] },
  { id: "meatsauce", name: "Meat Sauce", emoji: "🍲", meal: "dinner", color: "#c1121f",
    steps: [{ type: "counter", duration: 10, label: "Dice Onion & Garlic" }, { type: "stovetop", duration: 25, label: "Simmer" }] },
  { id: "garlicbread", name: "Garlic Bread", emoji: "🥖", meal: "dinner", color: "#e9b44c",
    steps: [{ type: "counter", duration: 5, label: "Butter & Herb" }, { type: "oven", duration: 10, label: "Bake" }] },
  { id: "bakedziti", name: "Baked Ziti", emoji: "🫕", meal: "dinner", color: "#9c6644",
    steps: [{ type: "counter", duration: 15, label: "Layer & Assemble" }, { type: "oven", duration: 30, label: "Bake" }] },
  { id: "roastchicken", name: "Roast Chicken", emoji: "🍗", meal: "dinner", color: "#c1121f",
    steps: [{ type: "counter", duration: 15, label: "Truss & Season" }, { type: "oven", duration: 75, label: "Roast" }, { type: "counter", duration: 15, label: "Rest & Carve" }] },
  { id: "beefstew", name: "Beef Stew", emoji: "🍖", meal: "dinner", color: "#7f4f24",
    steps: [{ type: "counter", duration: 15, label: "Sear & Dice" }, { type: "stovetop", duration: 45, label: "Simmer" }] },
  { id: "meatloaf", name: "Meatloaf", emoji: "🥩", meal: "dinner", color: "#9d0208",
    steps: [{ type: "counter", duration: 15, label: "Mix & Shape" }, { type: "oven", duration: 45, label: "Bake" }, { type: "counter", duration: 10, label: "Rest & Slice" }] },
  { id: "mashedpotatoes", name: "Mashed Potatoes", emoji: "🥔", meal: "dinner", color: "#e9b44c",
    steps: [{ type: "counter", duration: 10, label: "Peel & Cube" }, { type: "stovetop", duration: 20, label: "Boil" }, { type: "counter", duration: 5, label: "Mash & Butter" }] },
  { id: "roastedpotatoes", name: "Roasted Potatoes", emoji: "🥔", meal: "dinner", color: "#dda15e",
    steps: [{ type: "counter", duration: 10, label: "Cube & Toss" }, { type: "oven", duration: 35, label: "Roast" }] },
  { id: "ricepilaf", name: "Rice Pilaf", emoji: "🍚", meal: "dinner", color: "#e9c46a",
    steps: [{ type: "counter", duration: 5, label: "Toast Rice" }, { type: "stovetop", duration: 20, label: "Simmer" }] },
  { id: "greenbeans", name: "Green Beans", emoji: "🫛", meal: "dinner", color: "#3a9d5d",
    steps: [{ type: "counter", duration: 5, label: "Trim Ends" }, { type: "stovetop", duration: 10, label: "Sauté" }] },
  { id: "broccoli", name: "Steamed Broccoli", emoji: "🥦", meal: "dinner", color: "#2a9d8f",
    steps: [{ type: "counter", duration: 5, label: "Cut Florets" }, { type: "stovetop", duration: 10, label: "Steam" }] },
  { id: "carrots", name: "Roasted Carrots", emoji: "🥕", meal: "dinner", color: "#f3722c",
    steps: [{ type: "counter", duration: 10, label: "Peel & Chop" }, { type: "oven", duration: 25, label: "Roast" }] },
  { id: "corn", name: "Corn on the Cob", emoji: "🌽", meal: "dinner", color: "#f4d35e",
    steps: [{ type: "counter", duration: 5, label: "Husk" }, { type: "stovetop", duration: 10, label: "Boil" }] },
  ...
  { id: "gravy", name: "Gravy", emoji: "🥣", meal: "dinner", color: "#8a5a3d",
    steps: [{ type: "counter", duration: 5, label: "Whisk Roux" }, { type: "stovetop", duration: 10, label: "Simmer" }] },
  { id: "cranberrysauce", name: "Cranberry Sauce", emoji: "🍒", meal: "dinner", color: "#9d0208",
    steps: [{ type: "counter", duration: 5, label: "Rinse Berries" }, { type: "stovetop", duration: 15, label: "Simmer" }] },
  { id: "grilledsalmon", name: "Grilled Salmon", emoji: "🐟", meal: "dinner", color: "#457b9d",
    steps: [{ type: "counter", duration: 10, label: "Season" }, { type: "stovetop", duration: 15, label: "Grill" }, { type: "counter", duration: 5, label: "Plate & Drizzle" }] },
  { id: "shrimpscampi", name: "Shrimp Scampi", emoji: "🍤", meal: "dinner", color: "#e76f51",
    steps: [{ type: "counter", duration: 10, label: "Peel & Devein" }, { type: "stovetop", duration: 10, label: "Sauté" }] },
  { id: "lasagna", name: "Lasagna", emoji: "🧆", meal: "dinner", color: "#9c6644",
    steps: [{ type: "counter", duration: 25, label: "Layer Noodles" }, { type: "oven", duration: 45, label: "Bake" }, { type: "counter", duration: 10, label: "Rest & Slice" }] },
  { id: "stuffing", name: "Stuffing", emoji: "🍞", meal: "dinner", color: "#bc6c25",
    steps: [{ type: "counter", duration: 15, label: "Toast Bread Cubes" }, { type: "oven", duration: 30, label: "Bake" }] },
  { id: "turkey", name: "Roast Turkey", emoji: "🦃", meal: "dinner", color: "#9d0208",
    steps: [{ type: "counter", duration: 20, label: "Brine & Truss" }, { type: "oven", duration: 180, label: "Roast" }, { type: "counter", duration: 20, label: "Rest & Carve" }] },
  { id: "devilledeggs", name: "Deviled Eggs", emoji: "🥚", meal: "dinner", color: "#f4d35e",
    steps: [{ type: "stovetop", duration: 10, label: "Boil" }, { type: "counter", duration: 15, label: "Mash & Fill" }] },
  { id: "porkchops", name: "Pan-Seared Pork Chops", emoji: "🍖", meal: "dinner", color: "#a4633b",
    steps: [{ type: "counter", duration: 10, label: "Brine & Pat Dry" }, { type: "stovetop", duration: 15, label: "Sear" }, { type: "counter", duration: 5, label: "Rest & Slice" }] },
  { id: "beefwellington", name: "Beef Wellington", emoji: "🥩", meal: "dinner", color: "#7a2626",
    steps: [{ type: "counter", duration: 20, label: "Wrap in Pastry" }, { type: "oven", duration: 40, label: "Bake" }, { type: "counter", duration: 10, label: "Rest & Slice" }] },
  { id: "risotto", name: "Mushroom Risotto", emoji: "🍚", meal: "dinner", color: "#6b7a3f",
    steps: [{ type: "counter", duration: 10, label: "Sauté Mushrooms" }, { type: "stovetop", duration: 25, label: "Stir & Ladle Stock" }, { type: "counter", duration: 5, label: "Fold In Parmesan" }] },
  { id: "glazedham", name: "Glazed Ham", emoji: "🍖", meal: "dinner", color: "#c1666b",
    steps: [{ type: "counter", duration: 15, label: "Score & Glaze" }, { type: "oven", duration: 90, label: "Bake" }, { type: "counter", duration: 15, label: "Rest & Carve" }] },

  { id: "cookies", name: "Chocolate Chip Cookies", emoji: "🍪", meal: "dessert", color: "#6f4518",
    steps: [{ type: "counter", duration: 15, label: "Cream Butter & Sugar" }, { type: "oven", duration: 15, label: "Bake" }, { type: "counter", duration: 5, label: "Cool on Rack" }] },
  { id: "brownies", name: "Brownies", emoji: "🍫", meal: "dessert", color: "#4a2c2a",
    steps: [{ type: "counter", duration: 15, label: "Melt & Mix" }, { type: "oven", duration: 30, label: "Bake" }] },
  { id: "applepie", name: "Apple Pie", emoji: "🥧", meal: "dessert", color: "#c17a3d",
    steps: [{ type: "counter", duration: 20, label: "Roll Crust & Fill" }, { type: "oven", duration: 45, label: "Bake" }, { type: "counter", duration: 15, label: "Cool" }] },
  { id: "pumpkinpie", name: "Pumpkin Pie", emoji: "🎃", meal: "dessert", color: "#dd6e42",
    steps: [{ type: "counter", duration: 20, label: "Whisk Filling" }, { type: "oven", duration: 50, label: "Bake" }] },
  { id: "quiche", name: "Quiche", emoji: "🥧", meal: "dessert", color: "#e9b44c",
    steps: [{ type: "counter", duration: 20, label: "Whisk & Pour" }, { type: "oven", duration: 35, label: "Bake" }] },
  { id: "creamebrulee", name: "Crème Brûlée", emoji: "🍮", meal: "dessert", color: "#e9c46a",
    steps: [{ type: "counter", duration: 15, label: "Temper Custard" }, { type: "oven", duration: 40, label: "Bake" }, { type: "counter", duration: 5, label: "Torch Sugar Top" }] },
  { id: "cheesecake", name: "Cheesecake", emoji: "🍰", meal: "dessert", color: "#e6c288",
    steps: [{ type: "counter", duration: 20, label: "Press Crust & Whip" }, { type: "oven", duration: 55, label: "Bake" }, { type: "counter", duration: 10, label: "Chill & Set" }] },
];
